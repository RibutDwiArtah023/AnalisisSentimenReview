...
with st.container():
    ...
    if choose == "Home":
        ...
        st.markdown("# Dataset ")
        st.info("Data yang digunakan pada proyek ini adalah data ulasan pelayanan hotel di kota Jakarta. Data diperoleh dari informasi yang diekstraksi secara otomatis dari halaman web dengan metode web scrapping dengan lokasi pengumpulan data didaerah Jakarta dengan kategori khusus yaitu Hotel dengan data yang didapatkan sebanyak 210 data.")
        ...
        with desc:
            ...
            3.  Rating :
                > Tabel Rating berisi nilai yang diberikan oleh pengguna saat mengulas hotel.
            4. Review :
